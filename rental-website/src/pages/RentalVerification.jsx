...
const CompanyVerificationScreen = () => {
  ...
  useEffect(() => {
    const companyEmail = location.state?.email || Cookies.get('unverifiedCompanyEmail');
    if (!companyEmail) {
      navigate('/company-signup', { state: { error: 'No email found for verification' } });
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        'https://car-rental-backend-black.vercel.app/api/rental-companies/verify/rental-company',
        { 
          email,
  ...
  const handleResendCode = async () => {
    try {
      ...
      await axios.post(
        'https://car-rental-backend-black.vercel.app/api/rental-companies/resend-verification/rental-company',
        { email }
      );
        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              >
                {isLoading ? 'Verifying...' : 'Verify Company'}
              </button>
            </div>
          </form>
