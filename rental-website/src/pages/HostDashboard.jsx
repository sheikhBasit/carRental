        ...
        <table className="w-full">
          ...
          <tbody>
            {dashboardData.bookings.map((booking) => {
              // Find vehicle details for this booking if available
              const vehicle = dashboardData.vehicles.find(v => v._id === booking.vehicleId);
              ...
              return (
                <tr key={booking._id} className="border-b text-black hover:bg-gray-50">
                  ...
                  <td className="p-3">${booking.totalPrice?.toLocaleString() || '0'}</td>
                  <td className="p-3">
