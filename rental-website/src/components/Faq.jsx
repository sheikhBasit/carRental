  ...
  const faqs = [
    {
      ...
      answer: "To book a car on Turo, you must create a Turo account, be 18 years old or older in the US, 21 years old or older in the UK and Australia, 23 years old or older in Canada, have a valid driver's license, and get approved to drive on Turo. When you're booking your first trip, you'll go through a quick approval process by entering your driver's license and some other information. In most cases, you'll get approved immediately, and you'll be set for every future road trip, business trip, and family vacation!"
    },
    {
      question: "What payment methods does Turo accept?",
      answer: "Turo accepts most credit cards issued by major financial institutions, including American Express and Discover cards, as well as debit cards with a Visa or Mastercard logo that are linked to a checking account. Apple Pay and Google Pay on mobile devices are also accepted, but Turo does not accept cash or checks as valid payment methods."
    },
    {
      question: "Do I need my own insurance?",
      answer: "No, you don't need personal insurance coverage to book a car on Turo."
    },
    {
      question: "What is the cancellation policy for guests on Turo?",
    ...
    {
      question: "What protection plan options are available on Turo?",
      answer: "When booking a car on Turo, you'll choose between three protection plans — Premier, Standard, or Minimum — to get the level of protection that's right for you."
    },
    {
      question: "Is third-party auto liability insurance provided for trips on Turo?",
      answer: "Yes, Turo provides third-party auto liability insurance through a licensed insurance provider. This coverage protects you in case of bodily injury or property damage to others during your trip. The specific coverage limits vary depending on the protection plan you choose, so it's important to review the details when booking your vehicle."
    },
    {
      question: "Are there discounts on weekly or monthly trips?",
      answer: "Absolutely! Turo offers attractive discounts for longer trips. Typically, you can save 10-20% on weekly bookings and up to 30% on monthly rentals. These discounts vary by host and vehicle, so be sure to check the specific pricing for each car when planning an extended trip."
    },
    {
      question: "How can I drive unlimited miles during my trip on Turo?",
      answer: "Many hosts on Turo offer unlimited mileage for their vehicles. When browsing cars, look for listings that explicitly state 'Unlimited Miles' in the description. If a car doesn't offer unlimited miles, you'll typically see a per-mile rate that will be charged after you exceed the included mileage for your booking."
    },
    {
      question: "What are the cleaning and safety policies on Turo?",
      answer: "Turo takes cleaning and safety seriously. Hosts are required to thoroughly clean and sanitize their vehicles between trips. As a guest, you're expected to return the car in the same condition you received it. During the COVID-19 pandemic, Turo implemented enhanced cleaning guidelines to ensure vehicle safety, and many hosts continue to follow these rigorous standards."
    },
    {
      question: "Is Turo a rental car company?",
      answer: "Turo is not a traditional rental car company, but a peer-to-peer car sharing platform. Unlike traditional rental agencies, Turo allows private car owners to rent out their personal vehicles to travelers. This means you can often find unique, interesting, and more affordable vehicles compared to standard rental car options."
    },
    {
    ...
    },
    {
      ...
      answer: "Volkswagen availability depends on your specific location and the local Turo community. Many airports have a good selection of VW models, including popular options like the Jetta, Passat, and Tiguan. To find VWs near your airport, simply set your pickup location and filter the search results by Volkswagen brand when making your reservation."
    }
  ];
  return (
